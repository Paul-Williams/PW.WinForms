...
namespace PW.WinForms
{
  ...
  public static class MsgBox
  {
    ...
    {
      MessageBox.Show(owner, ex.MessageSafe(), Title ?? "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
    }
    ...
    /// </summary>
    public static void ShowError(Exception ex, string message, IWin32Window? owner = null)
    {
      MessageBox.Show(owner, message + Environment.NewLine + Environment.NewLine + ex.MessageSafe(), Title ?? "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
    }
    ...
    {
      MessageBox.Show(owner, message, Title ?? "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
    }
